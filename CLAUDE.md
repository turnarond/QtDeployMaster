...
2. **文档同步**：修改代码时，若涉及需求、接口、设计、架构、手册等内容，必须同步更新 `docs/` 中的对应文档。文档是交互接口与对齐标准，不是代码的附属品
...
| 组件 | 用途 |
|------|------|
| Qt 6.11.1 (Core/Gui/Widgets/Network/SerialBus/WebSockets) | 跨平台 UI + 网络 + Modbus |
...
- 安全审查报告见 `docs/01-方案设计/2026-07-05-FTP部署改进设计.md`
...
详细设计见 `docs/01-方案设计/2026-07-04-工具框架设计.md`。
实施计划见 `docs/02-实施计划/2026-07-04-工具框架计划.md`。
...
重构和 UI 设计的关键决策记录在 `docs/01-方案设计/` 和 `docs/02-实施计划/` 中，修改架构前应先查阅：

**对外交付文档**：
- `docs/03-架构与接口/架构设计.md` — 架构设计
- `docs/03-架构与接口/接口参考.md` — 接口参考
- `docs/04-构建与部署/用户手册.md` — 用户手册
- `docs/04-构建与部署/构建指南.md` — 构建指南
- `docs/04-构建与部署/安全说明.md` — 安全说明
- `docs/04-构建与部署/调试指南.md` — 调试问题排查
- `docs/04-构建与部署/Qt版本一致性说明.md`
- `docs/ROADMAP.md` — 项目路线图白皮书
- `docs/images/` — README 使用的界面截图

**方案设计文档**（`docs/01-方案设计/`，按日期+主题命名）：
- `2026-07-04-工具框架设计.md` — DeviceForge 2.0 核心架构设计
- `2026-07-05-DeviceForge命名设计.md` / `2026-07-05-FTP部署改进设计.md`
- `2026-07-08-网络中继设计.md` / `2026-07-09-产品化打磨设计.md`
- `2026-07-10-组播录制回放设计.md` / `2026-07-10-OPC-UA客户端设计.md` / `2026-07-10-SSH适配器设计.md`
- `2026-07-14-在线更新设计.md`
- 更早的历史设计文件见该目录（MVP+EventBus 架构，已过时但仍保留）

**实施计划文档**（`docs/02-实施计划/`）：
- `2026-07-04-工具框架计划.md` — Phase 0-1 框架搭建（15 Tasks，全部完成）
- `2026-07-05-FTP部署改进计划.md` / `2026-07-08-网络中继录制回放.md` / `2026-07-09-产品化打磨.md`
- `2026-07-10-组播录制回放.md` / `2026-07-10-OPC-UA客户端.md` / `2026-07-10-SSH适配器.md`
- `2026-07-14-在线更新计划.md`
- 更早的历史计划文件见该目录
